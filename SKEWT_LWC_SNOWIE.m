% Filename: SKEWT_LWC_SNOWIE.m
%
% Purpose: plots T (temp_cor_c) and Td (temp_frost_c) 
%          from SLWsonde in skew-t format
%
% Usage: run 'SKEWT_LWC_SNOWIE' after running 'loadplot_slwsonde'
...
FL  = [40 50] ;                 % Frequency Plot Limits
SL  = [0.0 1.4] ;               % SLWC Plot Limits
...
index1 = length(P);
line(TI(1:index1),P,'Parent',AX1,'Color','b','LineWidth',1.5) ;
...
if str2num(date_str) == 20170119 & date_flight_num ==1
  SLWC(end-1) = 0.60;
elseif str2num(date_str) == 20170118 & date_flight_num ==1
  SLWC(1) = 0.0;
elseif str2num(date_str) == 20170122 & date_flight_num ==1
  SLWC(2) = 0.0;  
elseif str2num(date_str) == 20170122 & date_flight_num ==3
  SLWC(1:3) = 0.0; 
end
%line(SLWC,PA(1:end-1),'Parent',AX3,'Color','b','LineWidth',1.5) ;
line(SLWC,PA,'Parent',AX3,'Color','b','LineWidth',1.5) ;
